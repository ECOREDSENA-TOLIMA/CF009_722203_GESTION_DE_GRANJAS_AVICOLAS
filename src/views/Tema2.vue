  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Recepción y selección del huevo comercial 
    ...
    .bloque-texto-g.bloque-texto-g--inverso.color-acento-botones.p-3.p-sm-4.p-md-5.mb-5
      ...
      .bloque-texto-g__texto.p-4
        p.mb-0 La cáscara es utilizada para mezclarla con la gallinaza para fortalecer el abono. En otras ocasiones en producciones pequeñas es picada y dada a las aves con el alimento para fortalecer la fijación de calcio en la nutrición de los animales. 

    p.mb-5 Por tal motivo, es importante entender las diferentes causas por las cuales se puede ocasionar un huevo sucio:
    ...
    ul.lista-ul.mb-5.ms-md-3
      ...
      li 
        i.lista-ul__vineta
        | Bandejas para 6 huevos.
      li  
        i.lista-ul__vineta
        | Bandeja para 12 huevos.
      li  
        i.lista-ul__vineta
        | Bandeja para 30 huevos.
